<!doctype html>
	...
	<head>
	    ...
	    <title>Edit Team Form - Reqd</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit Team</h4>
                        </div>
                    </div>
                </div>
            </div>
	            ...
	            <div class="main-content-inner">
				    ...
				    <!-- basic form start -->
	                            <div class="col-12 mt-5">
	                                <div class="card">
	                                    <div class="card-body">
	                                        <h4 class="header-title">Edit Team</h4>
	                                        <form>
							<fieldset disabled>
							...
							<div class="form-group">
								...
								<p>Hold ctrl to select multiple members</p>
								...
								<button type="button" class="btn btn-primary mt-4 pr-4 pl-4">New Member</button>
	                                        	</div>

	                                            <button type="button" class="btn btn-primary mt-4 pr-4 pl-4">Cancel</button>
						    <button type="button" class="btn btn-primary mt-4 pr-4 pl-4">Delete Team</button>
