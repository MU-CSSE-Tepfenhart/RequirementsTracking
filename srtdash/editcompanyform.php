<!doctype html>
	...
	<head>
	    ...
	    <title>Edit Company Form - Reqd</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit Company</h4>
                        </div>
                    </div>
                </div>
            </div>
				    ...
				    <!-- basic form start -->
							...
							<fieldset disabled>
								<div class="form-group">
	                                            			<label for="example-text-input" class="col-form-label">Company ID</label>
						    ...
						    <button type="button" class="btn btn-primary mt-4 pr-4 pl-4">Delete Company</button>
