<!doctype html>
	...
	<head>
	    ...
	    <title>Edit Member Form - Reqd</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit Member</h4>
                        </div>
                    </div>
                </div>
            </div>
				    ...
				    <!-- basic form start -->
							...
							<fieldset disabled>
								<div class="form-group">
	                                            			<label for="example-text-input" class="col-form-label">Member ID</label>
	                                            			<input class="form-control" type="text" value="#123456" id="example-text-input">
	                                        		</div>
							</fieldset>

							<div class="form-group">
	                                            		<label for="example-text-input" class="col-form-label">Member Name</label>
							...
							<div class="form-group">
								...
								<p>Hold ctrl to select multiple permissions</p>
						    ...
						    <button type="button" class="btn btn-primary mt-4 pr-4 pl-4">Delete Member</button>
