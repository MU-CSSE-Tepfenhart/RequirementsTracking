                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-3" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-po" role="tabpanel" aria-labelledby="nav-po-tab">
										...
										<fieldset>
											<legend>Permissions Available</legend>

											<div>
												<input type="checkbox" id="PermissionOne" name="feature"
													   value="Permission 1" checked />
												<label for="PermissionOne">Permission 1</label>
											</div>

											<div>
												<input type="checkbox" id="PermissionTwo" name="feature"
													   value="Permission 2" />
												<label for="PermissionTwo">Permission 2</label>
											</div>

											<div>
												<input type="checkbox" id="PermissionThree" name="feature"
													   value="Permission 3" />
												<label for="PermissionThree">Permission 3</label>
											</div>
